...
<head>
<title>
OOP Slideshow Gallery from Facebook
</title>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
<style>
body {font: 14px normal lucida sans, arial, sans-serif}
</style>
</head>
<body>
<style>
...
/*
-the eatonvance facebook page owns an app called "eatonvance.com" that has access to the page
-app was created by jlipinski@eatonvance.com and when added to eatonvance's biz page via app id the biz page "owned" the app
...
class social_fetch
{
	...
	private function create_url(){return $this->template_fill("url");} //populates url
	
	public function return_json()
	{
		$curl = curl_init();
		$storefile = "D:\\Temp\\" . $this->album_id . ".json"; //where to save json data
...
class facebook_slideshow extends social_fetch
{
	...
	{
		if(!empty($album_id)){$this->album_id=$album_id;}
		$photos = array();
		$return_data = $this->return_json();
...
facebook_slideshow::show("676452572552513");
